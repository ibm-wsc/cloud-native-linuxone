...
**5.** Scroll down to the  Pipelines section, and select the checkbox next to `Add pipeline`. You can also expand the `Show pipeline visualization` section to see a visual of the build pipeline.
